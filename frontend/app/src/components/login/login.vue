  ...
  <main class="bg-container">
    <div class="w-full max-w-sm bg-white p-8 rounded-lg shadow-md">
      <div class="flex items-center justify-center">
        <div class="logo-div">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#075e54" d="M160 368c26.5 0 48 21.5 48 48l0 16 72.5-54.4c8.3-6.2 18.4-9.6 28.8-9.6L448 368c8.8 0 16-7.2 16-16l0-288c0-8.8-7.2-16-16-16L64 48c-8.8 0-16 7.2-16 16l0 288c0 8.8 7.2 16 16 16l96 0zm48 124l-.2 .2-5.1 3.8-17.1 12.8c-4.8 3.6-11.3 4.2-16.8 1.5s-8.8-8.2-8.8-14.3l0-21.3 0-6.4 0-.3 0-4 0-48-48 0-48 0c-35.3 0-64-28.7-64-64L0 64C0 28.7 28.7 0 64 0L448 0c35.3 0 64 28.7 64 64l0 288c0 35.3-28.7 64-64 64l-138.7 0L208 492z"/></svg>
        </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <button class="w-full bg-gradient-to-r from-[#075e54] via-[#089678] to-[#075e54] text-white px-6 py-3 rounded-lg shadow-lg font-medium flex items-center justify-center hover:from-[#054d45] hover:via-[#067a62] hover:to-[#054d45] transition-all duration-300" type="submit" :disabled="isLoading">
      ...
      <p class="mt-4 text-center text-sm">
        ...
        <a href="#" class="text-[#075e54] font-semibold" @click.prevent="redirectSignup">Sign Up</a>
      </p>
    </div>
  </main>
</template>
  ...
  methods: {
    async handleLogin() {
      ...
      try {
        ...
        // The crucial check: Was the request successful?
        if (!response.ok) {
        ...
        // This runs whether it succeeds or fails, ensuring the spinner stops
